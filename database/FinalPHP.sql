...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertUsuario` (`UsuNombre_in` VARCHAR(50), `UsuClave_in` LONGBLOB, `PerTipoDocumento_in` VARCHAR(30), `PerDocumento_in` VARCHAR(11), `PerNombre_in` VARCHAR(50), `PerApellido_in` VARCHAR(50), `PerRh_in` VARCHAR(4), `PerFechaNacimiento_in` DATE, `URolId_in` INT)  BEGIN 
...
CREATE PROCEDURE insert_datosContacto (DatConDocumento_in VARCHAR(11),DatConDireccion_in VARCHAR(50),DatConTelefono_in VARCHAR(20),DatConCorreo_in VARCHAR (50))
INSERT INTO TblDatosContacto (DatConDocumento,DatConDireccion,DatConTelefono,DatConCorreo) VALUES (DatConDocumento_in,DatConDireccion_in,DatConTelefono_in,DatConCorreo_in);
