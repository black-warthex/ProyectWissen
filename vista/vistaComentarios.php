...
<nav class="navbar navbar-expand-lg navbar-light ">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">    
      ...
      <li class="nav-item">
        <a class="nav-link activo" id="color-letra-link" href="comentario.php">Comentarios</a>  
      </li>
       <li class="nav-item">
...
<div class="container">
     ...
     <h1>Gestion de Comentarios</h1>
      <p>Bienvenido a este modulo, puedes crear comentarios y visualizarlos</p>     
        <form action="" class="" method="POST">
        <H1 class="text-titulo-curso">Crear comentario</H1>       
        <label>Titulo</label>
           <input type="text" name="com_tip" required class="input_curso">
        <label>Comentario</label>
          <textarea name="com_com" class="input_curso" required></textarea>
        
        <input type="submit" class="btn-com btn btn-outline-warning btn-lg "  name="reg_com" value="ingresar">           
      </form>
      <hr/>
      <?php  if(isset($cmn)){?>
        
        <div class="cmt" id="cmt"><h1 class="text-titulo-curso">ver comentarios<h1></div>    
        
          <?php foreach($cmn as $c){ ?>     
          <div class="comentario">    
      <div class="tit" id="tit"><label><?php echo "Codigo $c[0]: Titulo $c[3]"; ?></label></div>
      <div class="des" id="des">
        <label class="style_l_comentario">Titulo: <p  class="campo_comentario"><?php echo "$c[3]"; ?></p></label>
      <label class="style_l_comentario">Autor:<p class="campo_comentario"><?php echo "$c[4]"; ?></p></label>
        <label class="style_l_comentario">Fecha: <p  class="campo_comentario"><?php echo "$c[1]"?></p></label>
        <label class="style_l_comentario">Comentario:<p class="campo_comentario"> <?php echo "$c[2]"?></p></label>
        </div>      
          </div>
      <?php }}?>
